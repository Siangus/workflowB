...
- [ ] A versioned SRS organizes the selected baseline's behavior, data, interfaces, qualities, constraints, assumptions, and dependencies without prescribing internal design.
