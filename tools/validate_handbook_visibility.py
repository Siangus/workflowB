...
def validate() -> tuple[list[str], list[str], dict]:
    ...
    required_design_docs = [
        "00-document-set-index.md", "00-charter.md", "01-requirements-baseline.md", "software-requirements-specification.md", "product-requirements-specification.md", "technical-design.md", "verification-and-acceptance-plan.md", "operations-and-slo.md", "evidence-register.md", "02-domain-and-state-model.md",
